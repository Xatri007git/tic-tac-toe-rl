...
rlplayer = RLPlayer()
if os.path.exists("q_table_v4.pkl"):
 with open("q_table_v4.pkl","rb") as f:
...
q_table_sarsa_old = "q_table_sarsa_onpol_v4.pkl"
q_table_sarsa_new = "q_table_sarsa_onpol_v4.pkl"
wins_rl_sarsa = "wins_rl_sarsa_onpol_v4.txt"
wins_pl_sarsa = "wins_pl_sarsa_onpol_v4.txt"
draws_sarsa = "draws_sarsa_onpol_v4.txt"
plot_sarsa = "plot_sarsa_onpol_v4.png"
